...
CLIENT_ID=$(git config --file scripts/caltech101_config --get google.client-id)
CLIENT_SECRET=$(git config --file scripts/caltech101_config --get google.client-secret)
REMOTE=__gdrive
...
for file_id in \
	"137RyRjvTBkBiIfeYBNZBtViDHQ6_Ewsp 101_ObjectCategories.tar.gz" \
	"175kQy3UsZ0wUEHZjqkUDdNVssr7bgh_m Annotations.tar"
do
